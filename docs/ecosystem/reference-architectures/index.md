...
:::{grid-item-card} Inference as a Service
:link: inference-as-a-service
:link-type: doc

Build LLM API endpoints using AMD Instinct GPUs with either a self-managed open
source stack or the AMD Enterprise AI Suite.
:::
